    ...
    <div className='space-y-2.5'>
      ...
      <div className='grid grid-cols-2 gap-1.5'>
        ...
        <SummaryField
          ...
          valueClassName='[&_div]:max-w-full'
        />
        <SummaryField label={t('Group')} cell={cells.get('group')} />
        <SummaryField
          label={t('Duration / First Token')}
          cell={cells.get('use_time')}
          valueClassName='overflow-x-auto'
        />
        <SummaryField label={t('Input')} cell={cells.get('prompt_tokens')} />
        <SummaryField
          label={t('Output')}
          cell={cells.get('completion_tokens')}
        />
        <SummaryField
          label={t('Cache')}
          cell={cells.get('cache_tokens')}
