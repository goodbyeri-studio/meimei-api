...
export function Wallet(props: WalletProps) {
  ...
  // Initialize the checkout with the first configured package.
  useEffect(() => {
    if (!topupInfo || topupAmount !== 0 || presetAmounts.length === 0) return

    const initialAmount = presetAmounts[0].value
  ...
  return (
    <>
      <SectionPageLayout>
        <SectionPageLayout.Title>{t('My Account')}</SectionPageLayout.Title>
        <SectionPageLayout.Content>
          <div className='mx-auto grid w-full max-w-[1540px] gap-4 xl:grid-cols-[minmax(0,1.25fr)_minmax(360px,0.75fr)] xl:items-stretch'>
