...
export type WechatNativePaymentResponse = ApiResponse<WechatNativeOrder>

export interface AlipayPrecreateOrder {
  trade_no: string
  qr_code?: string
  amount_fen: number
  expires_at: number
...
export type AlipayPrecreatePaymentResponse =
  ApiResponse<AlipayPrecreateOrder>
...
export interface TopupInfo {
  ...
  /** Whether WeChat Native QR payment is enabled */
  enable_wechat_pay?: boolean
  /** Whether Alipay QR payment is enabled */
...
export interface WechatNativePaymentRequest {
  /** Topup amount */
  amount: number
  /** Idempotency key generated by the browser */
  client_request_id: string
}

export interface AlipayPrecreatePaymentRequest {
  /** Topup amount */
  amount: number
  /** Idempotency key generated by the browser */
  client_request_id: string
