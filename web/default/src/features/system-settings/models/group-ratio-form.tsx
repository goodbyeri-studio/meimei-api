...
*/
import { Code2, Eye, HelpCircle, RefreshCw } from 'lucide-react'
...
import { DeepKeyGroupStatusPanel } from './deepkey-group-status-panel'
...
type GroupRatioFormProps = {
  ...
  onSyncDeepKeyGroups: () => void
  isSaving: boolean
  isSyncingDeepKeyGroups: boolean
}
    ...
    <div className='space-y-6'>
      <div className='flex flex-wrap justify-end gap-2'>
        <Button
          ...
          variant='outline'
          size='sm'
          onClick={onSyncDeepKeyGroups}
          disabled={isSyncingDeepKeyGroups}
        >
          <RefreshCw
            className={cn(
              'mr-2 h-4 w-4',
              isSyncingDeepKeyGroups && 'animate-spin'
            )}
          />
          {t('Sync DeepKey groups')}
        </Button>
