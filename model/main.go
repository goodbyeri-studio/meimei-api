...
func migrateDB() error {
	...
	if err := migrateDuplicateTokenNames(DB); err != nil {
		return err
	}
	...
	return seedDefaultCNYSubscriptionPlans()
}
...
func migrateDBFast() error {
	...
	migrations := []struct {
		...
		{&SubscriptionWechatPayOrder{}, "SubscriptionWechatPayOrder"},
		{&WechatPayNotification{}, "WechatPayNotification"},
		{&WechatPayRefund{}, "WechatPayRefund"},
		{&WechatPayRefundNotification{}, "WechatPayRefundNotification"},
		{&ChannelKeyUsage{}, "ChannelKeyUsage"},
		{&ManagedGroupState{}, "ManagedGroupState"},
	...
	if err := seedDefaultCNYSubscriptionPlans(); err != nil {
		return err
	}
